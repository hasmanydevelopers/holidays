...
module Holidays
  ...
  module Europe # :nodoc:
    DEFINED_REGIONS = [:cz, :dk, :no, :de, :de_bw, :de_by, :de_he, :de_nw, :de_rp, :de_sl, :de_st, :de_bb, :de_mv, :de_sn, :de_th, :es_pv, :es_ct, :es_na, :es_v, :es_vc, :es, :es_an, :es_ib, :es_cm, :es_mu, :es_m, :es_ar, :es_cl, :es_cn, :es_lo, :es_ga, :es_ce, :es_o, :es_ex, :fr, :gb, :ie, :gb_sct, :gb_con, :gb_nir, :je, :gb_jsy, :gg, :gb_gsy, :im, :gb_iom, :gb_eng, :gb_wls, :gb_eaw, :is, :it, :nl, :pt]
    ...
    HOLIDAYS_BY_MONTH = {
      0 => [{:function => lambda { |year| Holidays.easter(year)+1 }, :function_id => "easter(year)+1", :name => "Velikonoční pondělí", :regions => [:cz]},
            ...
            {:function => lambda { |year| Holidays.easter(year)-21 }, :function_id => "easter(year)-21", :logic => "4th Sunday in Lent", :name => "Mother's Day (Mothering Sunday)", :regions => [:gb]},
      ...
      1 => [{:mday => 1, :name => "Den obnovy samostatného českého státu", :regions => [:cz]},
            ...
            {:mday => 1, :logic => "January 1st", :name => "New Year's Day", :regions => [:gb, :ie]},
      ...
      5 => [{:mday => 1, :name => "Svátek práce", :regions => [:cz]},
            ...
            {:wday => 1, :week => 1, :logic => "1st Monday in May", :name => "May Day", :regions => [:gb, :ie]},
      ...
      12 => [{:mday => 24, :name => "Štědrý den", :regions => [:cz]},
            ...
            {:mday => 26, :observed => lambda { |date| Holidays.to_weekday_if_boxing_weekend(date) }, :observed_id => "to_weekday_if_boxing_weekend", :logic => "December 26th", :name => "Boxing Day", :regions => [:gb]},
      ...
      6 => [{:mday => 5, :name => "Grundlovsdag", :regions => [:dk]},
            ...
            {:wday => 0, :week => 3, :logic => "3rd Sunday in June", :name => "Father's Day", :regions => [:gb]},
            {:wday => 1, :week => 1, :name => "Bank Holiday", :regions => [:ie]},
