...
module Holidays
  ...
  module North_America # :nodoc:
    DEFINED_REGIONS = [:ca, :ca_qc, :ca_ab, :ca_on, :ca_sk, :ca_mb, :ca_nf, :us, :ca_nt, :ca_nu, :ca_bc, :ca_ns, :ca_yk, :mx, :mx_pue]
    ...
    HOLIDAYS_BY_MONTH = {
      ...
      7 => [{:mday => 1, :observed => lambda { |date| Holidays.to_monday_if_sunday(date) }, :observed_id => "to_monday_if_sunday", :logic => "July 1st", :name => "Canada Day", :regions => [:ca]},
