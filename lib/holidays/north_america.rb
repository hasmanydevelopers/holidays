...
module Holidays
  ...
  module North_America # :nodoc:
    DEFINED_REGIONS = [:ca, :us, :ca_qc, :ca_nf, :ca_nt, :ca_nu, :ca_ab, :ca_on, :ca_sk, :ca_mb, :ca_bc, :ca_ns, :ca_yk, :mx, :mx_pue, :us_dc]

    HOLIDAYS_BY_MONTH = {
      5 => [{:wday => 0, :week => 2, :name => "Mother's Day", :regions => [:ca, :us]},
      ...
      6 => [{:wday => 0, :week => 3, :name => "Father's Day", :regions => [:ca, :us]},
      ...
      12 => [{:mday => 26, :name => "Boxing Day", :regions => [:ca]},
            ...
            {:mday => 26, :name => "Kwanzaa", :regions => [:us]},
      ...
      10 => [{:wday => 1, :week => 2, :name => "Thanksgiving", :regions => [:ca]},
            ...
            {:mday => 31, :name => "Halloween", :regions => [:us]},
